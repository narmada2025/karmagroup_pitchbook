...
class SinglePlayerMomentsWidget extends StatefulWidget {
  ...
  const SinglePlayerMomentsWidget({
    super.key,
    required this.data,
    this.columns = 2,
    this.gap = 10,
  ...
  @override
  State<SinglePlayerMomentsWidget> createState() => _SinglePlayerMomentsWidgetState();
}

class _SinglePlayerMomentsWidgetState extends State<SinglePlayerMomentsWidget> {
