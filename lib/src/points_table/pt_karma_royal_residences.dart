...
class PtKarmaRoyalResidences extends StatefulWidget {
  final Map<String, dynamic> pointsData;
  final String lang;

  const PtKarmaRoyalResidences({
    super.key,
  ...
  @override
  State<PtKarmaRoyalResidences> createState() => _PtKarmaRoyalResidencesState();
}

class _PtKarmaRoyalResidencesState extends State<PtKarmaRoyalResidences> {
  ...
  Widget build(BuildContext context) {
    ...
    const double firstRowHeight = 100;
    const double rowHeight = 70;
    const String tabName = 'royal';
