...
class PtKarmaClubElite extends StatefulWidget {
  final Map<String, dynamic> pointsData;
  final String lang;

  const PtKarmaClubElite({
    super.key,
  ...
  @override
  State<PtKarmaClubElite> createState() => _PtKarmaClubEliteState();
}

class _PtKarmaClubEliteState extends State<PtKarmaClubElite> {
  ...
  Widget build(BuildContext context) {
    ...
    const double firstRowHeight = 150;
    const double rowHeight = 70;
    const String tabName = 'elite';
                      ...
                      children: [
                        ...
                        ...widget.pointsData.isNotEmpty
                            ? widget.pointsData[tabName]['points'].entries
                                .map<Widget>((entry) {
                                return const PointsTableLeftCol(
                                  height: rowHeight,
                                  firstCellFlex: 3,
                                  cellFlex: 2,
                                  gap: 2,
                            ...
                            ...widget.pointsData.isNotEmpty
                                ? widget.pointsData[tabName]['points'].entries
                                    ...
                                    return PointsTableRowContent(
                                      ...
                                      dailyColor: AppColors.tableGoldenLight2,
                                      weeklyColor: AppColors.tableGoldenLight,
                                    );
                                  }).toList()
                                : [],
                            Row(
